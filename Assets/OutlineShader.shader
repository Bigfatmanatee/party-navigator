Shader "Replacement Shaders/OutlineShader"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _Strength("Line Strength", Range(1, 500)) = 1.0
        _Mode("Mode", Range(0, 1)) = 1
        _Brightness("Brightness", Range(1, 10)) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float depthColor = tex2D(_CameraDepthTexture, i.uv).r * _Brightness;
                ...
                // Mutiply by "maincol" to get the outline + material effect
                return pixelColor * fixed4(depthColor, depthColor, depthColor, 1) * mainCol;
            }
            ENDCG
        }
    }
